    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Arboreto <sup>2</sup></div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Andres Saballos</span>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Gestión de Mapa</h1>
                    <p class="mb-4">Desde esta pantalla del sistema usted podrá controlar la creación, actualización y el dar de baja a los Mapas.</p>
					  ...
					  <div class="modal-dialog modal-dialog-centered" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalCenterTitle">Registrar Nuevo Mapa</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					         <form class="user" method="post" action="./SI_GestionMapa" >
								<!-- El valor de este input es para el Servlet opcion guardar -->
                            	<input name="opcion" type="hidden" value="1" />
                            	<div class="form-group row">
                                    <div class="col-sm-12 mb-3">
                                        <input type="text" class="form-control form-control-user" name="txtNombre" id="txtNombres"
                                            placeholder="nombre" required>
                                    </div>
                                     <div class="col-sm-12 mb-3">
                                        <input type="text" class="form-control form-control-user" name="txtsectorID" id="txtsectorID"
                                            placeholder="sectorID" required>
                                    </div>                              </div>
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3">
...
<!-- 					        <button type="button" class="btn btn-primary">Save changes</button> -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Mapas Registrados</h6>
                        </div>
                        <div class="card-body">
                        	<div align="right">
                        		...
                        		<a href="#" data-toggle="modal" data-target="#modalNewMapa">
                        			<i class="fas fa-plus-square fa-2x" title="Registrar Nuevo Mapa"></i>
                        		</a>
                        		<!-- FIN Button trigger modal -->
                        		&nbsp;&nbsp;
                        		<a href="#">
                        			<i class="fas fa-print fa-2x" title="Imprimir Lista de Mapas Activos"></i>
                        		</a>
                        		
                        	</div>
                        	
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tblMapa" width="100%" cellspacing="0">
                                <%
                                	ArrayList<Mapa> listMapas = new ArrayList<Mapa>();
                                Dt_Mapa Mp = new Dt_Mapa();
                                	listMapas = Mp.listaMapaActivos();
                                ...
                                %>
                                    ...
                                    <tbody>
                                   		<%
                                       		for(Mapa us: listMapas){
                                       	%>
                                       <tr>
                                           <td><%=us.getEstado()==1||us.getEstado()==2?"ACTIVO":"INACTIVO" %></td>
                                           <td><%=us.getNombre() %></td>
                                           <td><%=us.getMapaID() %></td>
                                           <td><%=us.getSectorID() %></td>
                                           <td>
                                           		<a id="btn-edita-abrir" href="editMapa.jsp?userID=<%=us.getMapaID()%>">
                        							<i class="fas fa-edit" title="Modificar datos del Mapa"></i>
                        						</a>
                                           		<a href="Sl_GestionMapa?mapaID=<%=us.getMapaID()%>">
                        							<i class="fas fa-trash-alt" title="Eliminar Mapa"></i>
                        						</a>
                                           		<a href="#">
