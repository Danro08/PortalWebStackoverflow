                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Registrar Nueva Floracion</h1>
                            </div>
                            <form class="user" method="post" action="./Sl_GestionFlor" >
                            	...
                            	<div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control form-control-user" name="txtTemporada" id="txtTemporada"
