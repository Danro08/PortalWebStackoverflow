...
<title>Agregar foto a Servicio</title>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Registrar Foto de Servicio</h1>
                            </div>
                            <div id="foto" class="panel">
								<form class="form" name="frm-foto" method="post" action="./Sl_FotoServ" enctype="multipart/form-data">
								<%
									int idServ = 0;
									Servicios serv = new Servicios();
									Dt_Servicios dts = new Dt_Servicios();
									idServ = Integer.parseInt(request.getParameter("idServicio"));
									serv = dts.getServicios(idServ);
								%>
								<div class="cuadro-fotoNima" align="center">
									<img id="preview" src="<%=serv.getUrl_foto()==null?"#":serv.getUrl_foto()%>" name="preview"  alt="Foto Servicio"
