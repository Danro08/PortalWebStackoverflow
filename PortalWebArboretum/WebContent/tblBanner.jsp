<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" import="entidades.banner, datos.Dt_Banner, java.util.*;" %>
<!DOCTYPE html>
<%
...
<title>Banners Registrados</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseSeguridad" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tblBanner.jsp">Banners</a>
                        <a class="collapse-item" href="editBanner.jsp">Editar Banner</a>
                        <a class="collapse-item" href="newBanner.jsp">Agregar Banner</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseArbol" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <h6 class="collapse-header">Mapa</h6>
                        <a class="collapse-item" href="tblMapa.jsp">Mapa</a>
                        <h6 class="collapse-header">Banner</h6>
                        <a class="collapse-item" href="tblBanner.jsp">Banner</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Andres S </span>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Gestión de Banner</h1>
                    <p class="mb-4">Desde esta pantalla del sistema usted podrá controlar la creación, actualización y el dar de baja a los banners.</p>
					
					<!-- MODAL NUEVO USUARIO -->
					<div class="modal fade" id="modalNewBanner" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
					  <div class="modal-dialog modal-dialog-centered" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalCenterTitle">Registrar Nuevo Banner</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					         <form class="user" method="post" action="./Sl_GestionBanner" >
								<!-- El valor de este input es para el Servlet opcion guardar -->
                            	<input name="opcion" type="hidden" value="1" />
                            	<div class="form-group row">
                                    <div class="col-sm-12 mb-3">
                                        <input type="text" class="form-control form-control-user" name="txtimg" id="txtimg"
...
<!-- 					        <button type="button" class="btn btn-primary">Save changes</button> -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Banners Registrados</h6>
                        </div>
                        <div class="card-body">
                        	<div align="right">
                        		<a href="newBanner.jsp">
                        			<i class="fas fa-user-plus fa-2x" title="Registrar Nuevo Banner"></i>
                        		</a>
                        		&nbsp;&nbsp;
                        		<!-- Button trigger modal -->
                        		<a href="#" data-toggle="modal" data-target="#modalNewUser">
                        			<i class="fas fa-plus-square fa-2x" title="Registrar Nuevo Banner"></i>
                        		</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tblbanner" width="100%" cellspacing="0">
                                <%
                                	ArrayList<banner> listUser = new ArrayList<banner>();
                                	Dt_Banner dtu = new Dt_Banner();
                                	listUser = dtu.listabannerActivos();
                                ...
                                %>
                                    ...
                                    <tbody>
                                   		<%
                                       		for(banner us: listUser){
                                       	%>
                                       <tr>
                                           <td><%=us.getImg() %></td>
                                           <td><%=us.getTbl_bannerID() %></td>
                                           <td><%=us.getEstado()==1||us.getEstado()==2?"ACTIVO":"INACTIVO" %></td>
                                           <td>
                                      
                                           		<a id="btn-edita-abrir" href="editBanner.jsp?bannerID=<%=us.getTbl_bannerID()%>">
                        							<i class="fas fa-edit" title="Modificar datos del Usuario"></i>
                        						</a>
                                           		<a href="Sl_GestionBanner?bannerID==<%=us.getTbl_bannerID()%>">
