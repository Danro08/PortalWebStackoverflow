...
<title>Edicion de Servicios</title>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Bienvenido a la edicion de Servicio</h1>
                            </div>
                            <%
                            	String us = "";
								us = request.getParameter("idServ")==null?"0":request.getParameter("idServ");
														
								Servicios serv = new Servicios();
								Dt_Servicios dts = new Dt_Servicios();
								serv = dts.getServicios(Integer.parseInt(us));
                            %>
...
<script>  
   $(document).ready(function()
	{
		$("#txtNombres").val("<%=serv.getNombre()%>");
		$("#txtApellidos").val("<%=serv.getDescripcion()%>");
	});
</script>
