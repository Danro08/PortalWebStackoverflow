...
<title>Flores Registradas</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Gestión de Flores</h1>
                    <p class="mb-4">Desde esta pantalla del sistema usted podrá controlar la creación, actualización y el dar de baja a las flores.</p>
					
					<!-- MODAL NUEVA FLORACION -->
					<div class="modal fade" id="modalNewFloracion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
					  <div class="modal-dialog modal-dialog-centered" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalCenterTitle">Registrar Nueva Floracion</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					         <form class="user" method="post" action="./Sl_GestionFlor" >
								<!-- El valor de este input es para el Servlet opcion guardar -->
                            	<input name="opcion" type="hidden" value="1" />
                            	<div class="form-group row">
                                    <div class="col-sm-12 mb-3">
                                        <input type="text" class="form-control form-control-flor" name="txtNombre" id="txtNombre"
                                            placeholder="Nombre de floracion" required>
                                    </div>
                                    <div class="col-sm-12">
...
<!-- 					        <button type="button" class="btn btn-primary">Save changes</button> -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Floraciones Registradas</h6>
                        </div>
                        <div class="card-body">
                        	<div align="right">
                        		<a href="newFloracion.jsp">
                        			<i class="fas fa-user-plus fa-2x" title="Registrar Nueva Floracion"></i>
                        		</a>
                        		&nbsp;&nbsp;
                        		<!-- Button trigger modal -->
                        		<a href="#" data-toggle="modal" data-target="#modalNewFloracion">
                        			<i class="fas fa-plus-square fa-2x" title="Registrar Nuevo Floracion"></i>
                        		</a>
                        		<!-- FIN Button trigger modal -->
                        		&nbsp;&nbsp;
                        		<a href="#">
                        			<i class="fas fa-print fa-2x" title="Imprimir Lista de Floraciones Activas"></i>
                        		</a>
                            ...
                            <div class="table-responsive">
                                ...
                                <%
                                	...
                                	listFloracion = dtf.listaFloracionActivos();
                                ...
                                %>
                                    ...
                                    <tbody>
                                   		<%
                                       		for(Floracion flor: listFloracion){
                                       	%>
                                       <tr>
                                           <td><%=flor.getFloracionID() %></td>
                                           <td><%=flor.getNombre() %></td>
                                           <td><%=flor.getTemporada() %></td>
                                           <td><%=flor.getDescripcion() %></td>
                                           <td><%=flor.getEstado()==1||flor.getEstado()==2?"ACTIVO":"INACTIVO" %></td>
                                           <td>
                                           		<a id="btn-edita-abrir" href="editFloracion.jsp?florID=<%=flor.getFloracionID() %>">
                        							<i class="fas fa-edit" title="Modificar datos de la floracion"></i>
                        						</a>
                                           		<a href="Sl_GestionFlor?idF=<%=flor.getFloracionID()%>">
                        							<i class="fas fa-trash-alt" title="Eliminar floracion"></i>
                        						</a>
                                           		<a href="#">
                        							<i class="fas fa-eye" title="Visualizar floracion"></i>
                        						</a><%-- 
