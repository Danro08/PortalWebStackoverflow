        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Desde esta pantalla del sistema usted podrá controlar la creación, actualización y el dar de baja a los Servicios del portal Web.</p>
					  ...
					  <div class="modal-dialog modal-dialog-centered" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalCenterTitle">Registrar Nuevo Servicio</h5>
                        ...
                        <div class="card-body">
                        	<div align="right">
                             ...
                             <div class="table-responsive">
                                <table class="table table-bordered" id="tblServ" width="100%" cellspacing="0">
                                <%
                                ...
                                %>
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                           		<a id="btn-edita-abrir" href="editServicio.jsp?IdServ<%=serv.getIdServ()%>">
                        							<i class="fas fa-edit" title="Modificar datos del Servicio"></i>
                        						</a>
                                           		<a href="Sl_GestionServicios?idServ=<%=serv.getIdServ()%>">
