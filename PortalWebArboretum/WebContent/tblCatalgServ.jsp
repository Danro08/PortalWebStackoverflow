        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Gestión del Catalogo de Servicios</h1>
                    <p class="mb-4">Desde esta pantalla del sistema usted podrá controlar la creación, actualización y el dar de baja lo que aparece en el Catalogo de Servicios del portal Web.</p>
					
					<!-- MODAL NUEVO SERVICIO -->
					<div class="modal fade" id="modalNewServ" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
					  <div class="modal-dialog modal-dialog-centered" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalCenterTitle">Registrar Nuevo Catalogo De servicio</h5>
...
<!-- 					        <button type="button" class="btn btn-primary">Save changes</button> -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Catalogos Disponibles</h6>
                        </div>
                        <div class="card-body">
                        	<div align="right">
                        		<a href="newServicio.jsp">
                        			<i class="fas fa-user-plus fa-2x" title="Nuevo Servicio"></i>
                        		</a>
                        		&nbsp;&nbsp;
                        		<!-- Button trigger modal -->
                        		<a href="#" data-toggle="modal" data-target="#modalNewServ">
                        			<i class="fas fa-plus-square fa-2x" title="Nuevo Servicio"></i>
                        		</a>
                        		<!-- FIN Button trigger modal -->
                        		&nbsp;&nbsp;
                        		<a href="#">
                        			<i class="fas fa-print fa-2x" title="Imprimir Lista de Servicios activos"></i>
                        		</a>
                        		
                        	</div>
                        	
                             <div class="table-responsive">
                                <table class="table table-bordered" id="tblCServ" width="100%" cellspacing="0">
                                <%
                                ArrayList<CatalgServ> listCServ = new ArrayList<CatalgServ>();
                            	Dt_CatalgServ dts = new Dt_CatalgServ();
                            	listCServ = dts.listaCatalgServActivos();
                                %>
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                   		<%
                                       		for(CatalgServ cserv: listCServ){
                                       	%>
                                       <tr>
                                           <td><%=cserv.getIdCatalgoServ()%></td>
                                           <td><%=cserv.getNombre() %></td>
                                           <td><%=cserv.getTipo() %></td>
                                           <td><%=cserv.getEstado()==1||cserv.getEstado()==2?"ACTIVO":"INACTIVO" %></td>
                                           <td>
                                           		<a id="btn-edita-abrir" href="#">
                        							<i class="fas fa-edit" title="Modificar datos del Servicio"></i>
                        						</a>
                                           		<a href="#">
