        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Desde esta pantalla del sistema usted podrá controlar la creación, actualización y el dar de baja a los diferentes tipos de productos</p>
					  ...
					  <div class="modal-dialog modal-dialog-centered" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalCenterTitle">Registrar Nuevo tipo de producto</h5>
					         ...
					         <form class="user" method="post" action="./Sl_tipoProducto" >
                            	...
                            	<div class="form-group row">
                                    <div class="col-sm-12 mb-3">
                                        <input type="text" class="form-control form-control-user" name="txttipoProducto" id="txtTipo_producto"
                                            placeholder="Nombre de tipo de producto" required>
                                    </div>
                                    <div class="col-sm-12">
                                        <textarea name="txtdescrip_tipo" placeholder="Describa el tipo de producto"id="txtDescrip_tipo" rows="7" maxlength="100" required></textarea>
                                    </div>
                                </div>
...
<!-- 					        <button type="button" class="btn btn-primary">Save changes</button> -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tipos de productos registrados</h6>
                        </div>
                        <div class="card-body">
                        	<div align="right">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tbltipoProducto" width="100%" cellspacing="0">
                                <%
                                	ArrayList<tipoProducto> listTP = new ArrayList<tipoProducto>();
                                	Dt_tipoProducto dtp = new Dt_tipoProducto();
                                	listTP = dtp.listaTPactivos();
                                ...
                                %>
                                    ...
                                    <tbody>
                                   		<%
                                       		for(tipoProducto r: listTP){
                                       	%>
                                       <tr>
                                           <td><%=r.getTipoproductoID() %></td>
                                           <td><%=r.getTipo_producto() %></td>
                                           <td><%=r.getDescrip_tipo() %></td>
                                           <td><%=r.getEstado()==1||r.getEstado()==2?"ACTIVO":"INACTIVO" %></td>
                                           <td>
                                           		<a id="btn-edita-abrir" href="editTP.jsp?rolID=<%=r.getTipoproductoID()%>">
