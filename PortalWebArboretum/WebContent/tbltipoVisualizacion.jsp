...
import="entidades.tipoVisualizacion, datos.Dt_tipoDeVisualizacion, java.util.*;" %>
<!DOCTYPE html>
<html>
...
<title>Tipos de visualizacion</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseServicios" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tbltipoProducto.jsp">Tipo de productos</a>
                        <a class="collapse-item" href="tbltipoVisualizacion.jsp">Tipo de visualizacion</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Gestión de tipos de visualizacion</h1>
                    <p class="mb-4">Desde esta pantalla del sistema usted podrá controlar la creación, actualización y el dar de baja a los diferentes tipos de visualizacion</p>
					  ...
					  <div class="modal-dialog modal-dialog-centered" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalCenterTitle">Registrar Nuevo tipo de visualizacion</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					         <form class="user" method="post" action="./Sl_tipoProducto" >
                            	...
                            	<div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea name="txtnombre" placeholder="Nombre"id="txtnombre" rows="7" maxlength="100" required></textarea>
                                    </div>
                                </div>
...
<!-- 					        <button type="button" class="btn btn-primary">Save changes</button> -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tipos de visualizacion registrados</h6>
                        </div>
                        <div class="card-body">
                        	<div align="right">
                        		<!-- Button trigger modal -->
                        		<a href="#" data-toggle="modal" data-target="#modalNewRol">
                        			<i class="fas fa-plus-square fa-2x" title="Registrar nuevo tipo de producto"></i>
                        		</a>
                        		<!-- FIN Button trigger modal -->
                        		&nbsp;&nbsp;
                        		<a href="#">
                        			<i class="fas fa-print fa-2x" title="Imprimir Lista de tipos de productos Activos"></i>
                        		</a>
                        		
                        	</div>
                        	
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tbltipoVisualizacion" width="100%" cellspacing="0">
                                <%
                                ArrayList<tipoVisualizacion> listTV = new ArrayList<tipoVisualizacion>();
                                Dt_tipoDeVisualizacion dtv = new Dt_tipoDeVisualizacion();
                                	listTV = dtv.listaTVactivos();
                                	
                                %>
                                    <thead>
                                        <tr>
                                            <th>Tipo visualizacion ID</th>
                                            <th>Nombre</th>
                                            <th>Descripcion</th>
                                            <th>Estado</th>
                                        </tr>
                                    ...
                                    <tbody>
                                   		<%
                                   			for(tipoVisualizacion r: listTV){
                                       	%>
                                       <tr>
                                           <td><%=r.getTipodevisualizacionID() %></td>
                                           <td><%=r.getNombre() %></td>
                                           <td><%=r.getDescripcion() %></td>
                                           <td><%=r.getEstado()==1||r.getEstado()==2?"ACTIVO":"INACTIVO" %></td>
                                           <td>
                                           		<a id="btn-edita-abrir" href="editTV.jsp?rolID=<%=r.getTipodevisualizacionID()%>">
...
<script>
    $(document).ready(function ()
    {
        ...
        $('#tbltipoDeVisualizacion').DataTable({
            dom: 'Bfrtip',
            buttons: [
//             'pdf',
            'excel',
