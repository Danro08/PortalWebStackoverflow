        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Roles Asignados</h1>
                    <p class="mb-4">Desde esta pantalla del sistema usted podrá controlar y asignar a los usuarios, sus respectivos roles.</p>
...
<!-- 					        <button type="button" class="btn btn-primary">Save changes</button> -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Roles Asignados a usuarios</h6>
                        </div>
                        <div class="card-body">
                        	<div align="right">
                        		<a href="rolUser.jsp">
