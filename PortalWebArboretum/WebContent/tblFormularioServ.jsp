        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Gestión de Solicitudes de Servicios</h1>
                    <p class="mb-4">Desde esta pantalla del sistema usted podrá vizualizar y controlar el dar de baja a los Formularios del portal Web.</p>
				
					
                    <!-- DataTables Servicios -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Solicitudes Actuales</h6>
                        </div>
                        	
                             <div class="table-responsive">
                                <table class="table table-bordered" id="tblFServ" width="100%" cellspacing="0">
                                <%
                                ArrayList<FormularioServ> listFServ = new ArrayList<FormularioServ>();
                            	Dt_FormularioServ dtfs = new Dt_FormularioServ();
                            	listFServ = dtfs.listaFServActivos();
                                ...
                                %>
                                    ...
                                    <tbody>
                                   		<%
                                       		for(FormularioServ Fserv: listFServ){
                                       	%>
                                       <tr>
                                       		<td><%=Fserv.getIdFormulario()%></td>
                                           <td><%=Fserv.getIdServ()%></td>
                                           <td><%=Fserv.getNombreUsuario()%></td>
                                           <td><%=Fserv.getEmail() %></td>
                                           <td><%=Fserv.getCuerpoEmail() %></td>
                                           <td><%=Fserv.getNumerotelefono() %></td>
                                           <td><%=Fserv.getEstado()==1||Fserv.getEstado()==2?"ACTIVO":"INACTIVO" %></td>
                                           <td>
                                           		
                                           		<a href="Sl_GestionFormulario?idFormulario=<%=Fserv.getIdFormulario()%>">
