<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" import="entidades.Familia, datos.Dt_Familia, java.util.*;" %>
<!DOCTYPE html>
<%
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Desde esta pantalla del sistema usted podrá controlar la creación, actualización y el dar de baja a las familias.</p>
...
<!-- 					        <button type="button" class="btn btn-primary">Save changes</button> -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Familias Registradas</h6>
                        </div>
                        <div class="card-body">
                        	<div align="right">
                        		<a href="newFamilia.jsp">
                        			<i class="fas fa-user-plus fa-2x" title="Registrar Nueva Familia"></i>
                        		</a>
                        		&nbsp;&nbsp;
                        		<!-- Button trigger modal -->
                        		<a href="#" data-toggle="modal" data-target="#modalNewFloracion">
                        			<i class="fas fa-plus-square fa-2x" title="Registrar Nueva Familia"></i>
                        		</a>
                        		<!-- FIN Button trigger modal -->
                        		&nbsp;&nbsp;
                        		<a href="#">
                        			<i class="fas fa-print fa-2x" title="Imprimir Lista de Familias Activas"></i>
                        		</a>
                            ...
                            <div class="table-responsive">
                                ...
                                <%
                                	ArrayList<Familia> listFamilia = new ArrayList<Familia>();
                               		...
                               		listFamilia = dtfa.listaFamiliaActivos();
                                ...
                                %>
                                    ...
                                    <tbody>
                                   		<%
                                   			for(Familia fam: listFamilia){
                                       	%>
                                       <tr>
                                           <td><%=fam.getFamiliaID() %></td>
                                           <td><%=fam.getNombre() %></td>
                                           <td><%=fam.getDescripcion() %></td>
                                           <td><%=fam.getEstado()==1||fam.getEstado()==2?"ACTIVO":"INACTIVO" %></td>
                                           <td>
                                           		<a id="btn-edita-abrir" href="editFamilia.jsp?familiaID=<%=fam.getFamiliaID() %>">
                        							<i class="fas fa-edit" title="Modificar datos de la familia"></i>
                        						</a>
                                           		<a href="Sl_GestionFamilia?idFa=<%=fam.getFamiliaID()%>">
                        							<i class="fas fa-trash-alt" title="Eliminar familia"></i>
                        						</a>
                                           		<a href="#">
                        							<i class="fas fa-eye" title="Visualizar familia"></i>
                        						</a><%-- 
